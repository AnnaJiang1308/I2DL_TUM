...
class DataLoader:
    ...
    def __iter__(self):
        ...
        def build_batch_iterator(dataset, batch_size, shuffle):
            if shuffle:
                index_iterator = np.random.permutation(len(dataset))  # define indices as iterator
            else:
                index_iterator = range(len(dataset))  # define indices as iterator
        ...
        batch_iterator=build_batch_iterator(self.dataset,self.batch_size,self.shuffle)
    ...
    def __len__(self):
        ...
        ########################################################################
        if self.drop_last:
            length= np.size(self.dataset)//self.batch_size
        else :
            length= np.size(self.dataset)//self.batch_size+1
